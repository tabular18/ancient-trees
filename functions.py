...
def groupSpecies(rowstring, grouplist):
    ...
    Args:
        rowstring (string): listed species of the tree (human-inputted)
        grouplist (list): accepted list of tree families 

    Returns:
        string: identified tree family, or the original species
    """
...
def makePivot(data, col, delim):
    ...
    Args:
        ...
        col (string): name of the column to split/pivot
        delim (string): the text delimiter used to list markers in the given column, used to perform a split operation
